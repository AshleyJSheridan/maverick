...
/*Table structure for table `maverick_cms_language_cultures` */

DROP TABLE IF EXISTS `maverick_cms_language_cultures`;

CREATE TABLE `maverick_cms_language_cultures` (
  `id` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,
  `culture_name` varchar(10) NOT NULL,
  `display_name` varchar(100) NOT NULL,
  `culture_code` varchar(7) NOT NULL,
  `iso_639x` varchar(4) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=255 DEFAULT CHARSET=utf8;

/*Data for the table `maverick_cms_language_cultures` */

insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (1,'af-ZA','Afrikaans - South Africa','0x0436','AFK');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (2,'sq-AL','Albanian - Albania','0x041C','SQI');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (3,'ar-DZ','Arabic - Algeria','0x1401','ARG');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (4,'ar-BH','Arabic - Bahrain','0x3C01','ARH');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (5,'ar-EG','Arabic - Egypt','0x0C01','ARE');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (6,'ar-IQ','Arabic - Iraq','0x0801','ARI');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (7,'ar-JO','Arabic - Jordan','0x2C01','ARJ');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (8,'ar-KW','Arabic - Kuwait','0x3401','ARK');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (9,'ar-LB','Arabic - Lebanon','0x3001','ARB');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (10,'ar-LY','Arabic - Libya','0x1001','ARL');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (11,'ar-MA','Arabic - Morocco','0x1801','ARM');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (12,'ar-OM','Arabic - Oman','0x2001','ARO');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (13,'ar-QA','Arabic - Qatar','0x4001','ARQ');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (14,'ar-SA','Arabic - Saudi Arabia','0x0401','ARA');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (15,'ar-SY','Arabic - Syria','0x2801','ARS');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (16,'ar-TN','Arabic - Tunisia','0x1C01','ART');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (17,'ar-AE','Arabic - United Arab Emirates','0x3801','ARU');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (18,'ar-YE','Arabic - Yemen','0x2401','ARY');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (19,'hy-AM','Armenian - Armenia','0x042B','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (20,'Cy-az-AZ','Azeri (Cyrillic) - Azerbaijan','0x082C','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (21,'Lt-az-AZ','Azeri (Latin) - Azerbaijan','0x042C','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (22,'eu-ES','Basque - Basque','0x042D','EUQ');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (23,'be-BY','Belarusian - Belarus','0x0423','BEL');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (24,'bg-BG','Bulgarian - Bulgaria','0x0402','BGR');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (25,'ca-ES','Catalan - Catalan','0x0403','CAT');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (26,'zh-CN','Chinese - China','0x0804','CHS');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (27,'zh-HK','Chinese - Hong Kong SAR','0x0C04','ZHH');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (28,'zh-MO','Chinese - Macau SAR','0x1404','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (29,'zh-SG','Chinese - Singapore','0x1004','ZHI');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (30,'zh-TW','Chinese - Taiwan','0x0404','CHT');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (31,'zh-CHS','Chinese (Simplified)','0x0004','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (32,'zh-CHT','Chinese (Traditional)','0x7C04','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (33,'hr-HR','Croatian - Croatia','0x041A','HRV');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (34,'cs-CZ','Czech - Czech Republic','0x0405','CSY');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (35,'da-DK','Danish - Denmark','0x0406','DAN');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (36,'div-MV','Dhivehi - Maldives','0x0465','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (37,'nl-BE','Dutch - Belgium','0x0813','NLB');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (38,'nl-NL','Dutch - The Netherlands','0x0413','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (39,'en-AU','English - Australia','0x0C09','ENA');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (40,'en-BZ','English - Belize','0x2809','ENL');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (41,'en-CA','English - Canada','0x1009','ENC');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (42,'en-CB','English - Caribbean','0x2409','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (43,'en-IE','English - Ireland','0x1809','ENI');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (44,'en-JM','English - Jamaica','0x2009','ENJ');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (45,'en-NZ','English - New Zealand','0x1409','ENZ');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (46,'en-PH','English - Philippines','0x3409','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (47,'en-ZA','English - South Africa','0x1C09','ENS');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (48,'en-TT','English - Trinidad and Tobago','0x2C09','ENT');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (49,'en-GB','English - United Kingdom','0x0809','ENG');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (50,'en-US','English - United States','0x0409','ENU');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (51,'en-ZW','English - Zimbabwe','0x3009','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (52,'et-EE','Estonian - Estonia','0x0425','ETI');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (53,'fo-FO','Faroese - Faroe Islands','0x0438','FOS');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (54,'fa-IR','Farsi - Iran','0x0429','FAR');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (55,'fi-FI','Finnish - Finland','0x040B','FIN');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (56,'fr-BE','French - Belgium','0x080C','FRB');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (57,'fr-CA','French - Canada','0x0C0C','FRC');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (58,'fr-FR','French - France','0x040C','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (59,'fr-LU','French - Luxembourg','0x140C','FRL');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (60,'fr-MC','French - Monaco','0x180C','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (61,'fr-CH','French - Switzerland','0x100C','FRS');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (62,'gl-ES','Galician - Galician','0x0456','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (63,'ka-GE','Georgian - Georgia','0x0437','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (64,'de-AT','German - Austria','0x0C07','DEA');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (65,'de-DE','German - Germany','0x0407','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (66,'de-LI','German - Liechtenstein','0x1407','DEC');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (67,'de-LU','German - Luxembourg','0x1007','DEL');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (68,'de-CH','German - Switzerland','0x0807','DES');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (69,'el-GR','Greek - Greece','0x0408','ELL');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (70,'gu-IN','Gujarati - India','0x0447','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (71,'he-IL','Hebrew - Israel','0x040D','HEB');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (72,'hi-IN','Hindi - India','0x0439','HIN');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (73,'hu-HU','Hungarian - Hungary','0x040E','HUN');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (74,'is-IS','Icelandic - Iceland','0x040F','ISL');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (75,'id-ID','Indonesian - Indonesia','0x0421','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (76,'it-IT','Italian - Italy','0x0410','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (77,'it-CH','Italian - Switzerland','0x0810','ITS');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (78,'ja-JP','Japanese - Japan','0x0411','JPN');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (79,'kn-IN','Kannada - India','0x044B','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (80,'kk-KZ','Kazakh - Kazakhstan','0x043F','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (81,'kok-IN','Konkani - India','0x0457','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (82,'ko-KR','Korean - Korea','0x0412','KOR');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (83,'ky-KZ','Kyrgyz - Kazakhstan','0x0440','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (84,'lv-LV','Latvian - Latvia','0x0426','LVI');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (85,'lt-LT','Lithuanian - Lithuania','0x0427','LTH');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (86,'mk-MK','Macedonian (FYROM)','0x042F','MKD');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (87,'ms-BN','Malay - Brunei','0x083E','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (88,'ms-MY','Malay - Malaysia','0x043E','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (89,'mr-IN','Marathi - India','0x044E','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (90,'mn-MN','Mongolian - Mongolia','0x0450','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (91,'nb-NO','Norwegian (Bokm̴l) - Norway','0x0414','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (92,'nn-NO','Norwegian (Nynorsk) - Norway','0x0814','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (93,'pl-PL','Polish - Poland','0x0415','PLK');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (94,'pt-BR','Portuguese - Brazil','0x0416','PTB');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (95,'pt-PT','Portuguese - Portugal','0x0816','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (96,'pa-IN','Punjabi - India','0x0446','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (97,'ro-RO','Romanian - Romania','0x0418','ROM');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (98,'ru-RU','Russian - Russia','0x0419','RUS');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (99,'sa-IN','Sanskrit - India','0x044F','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (100,'Cy-sr-SP','Serbian (Cyrillic) - Serbia','0x0C1A','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (101,'Lt-sr-SP','Serbian (Latin) - Serbia','0x081A','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (102,'sk-SK','Slovak - Slovakia','0x041B','SKY');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (103,'sl-SI','Slovenian - Slovenia','0x0424','SLV');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (104,'es-AR','Spanish - Argentina','0x2C0A','ESS');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (105,'es-BO','Spanish - Bolivia','0x400A','ESB');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (106,'es-CL','Spanish - Chile','0x340A','ESL');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (107,'es-CO','Spanish - Colombia','0x240A','ESO');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (108,'es-CR','Spanish - Costa Rica','0x140A','ESC');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (109,'es-DO','Spanish - Dominican Republic','0x1C0A','ESD');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (110,'es-EC','Spanish - Ecuador','0x300A','ESF');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (111,'es-SV','Spanish - El Salvador','0x440A','ESE');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (112,'es-GT','Spanish - Guatemala','0x100A','ESG');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (113,'es-HN','Spanish - Honduras','0x480A','ESH');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (114,'es-MX','Spanish - Mexico','0x080A','ESM');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (115,'es-NI','Spanish - Nicaragua','0x4C0A','ESI');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (116,'es-PA','Spanish - Panama','0x180A','ESA');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (117,'es-PY','Spanish - Paraguay','0x3C0A','ESZ');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (118,'es-PE','Spanish - Peru','0x280A','ESR');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (119,'es-PR','Spanish - Puerto Rico','0x500A','ES');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (120,'es-ES','Spanish - Spain','0x0C0A','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (121,'es-UY','Spanish - Uruguay','0x380A','ESY');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (122,'es-VE','Spanish - Venezuela','0x200A','ESV');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (123,'sw-KE','Swahili - Kenya','0x0441','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (124,'sv-FI','Swedish - Finland','0x081D','SVF');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (125,'sv-SE','Swedish - Sweden','0x041D','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (126,'syr-SY','Syriac - Syria','0x045A','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (127,'ta-IN','Tamil - India','0x0449','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (128,'tt-RU','Tatar - Russia','0x0444','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (129,'te-IN','Telugu - India','0x044A','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (130,'th-TH','Thai - Thailand','0x041E','THA');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (131,'tr-TR','Turkish - Turkey','0x041F','TRK');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (132,'uk-UA','Ukrainian - Ukraine','0x0422','UKR');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (133,'ur-PK','Urdu - Pakistan','0x0420','URD');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (134,'Cy-uz-UZ','Uzbek (Cyrillic) - Uzbekistan','0x0843','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (135,'Lt-uz-UZ','Uzbek (Latin) - Uzbekistan','0x0443','');
insert  into `maverick_cms_language_cultures`(`id`,`culture_name`,`display_name`,`culture_code`,`iso_639x`) values (136,'vi-VN','Vietnamese - Vietnam','0x042A','VIT');
...
insert  into `maverick_cms_logins`(`id`,`username`,`ip`,`user_agent`,`login_at`,`successful`) values (32,'admin','127.0.0.1','Mozilla/5.0 (X11; Linux i686; rv:26.0) Gecko/20100101 Firefox/26.0','2015-07-27 18:28:09','yes');
...
insert  into `maverick_cms_logs`(`id`,`user_id`,`type`,`category`,`sub_category`,`details`,`added_at`,`request_data`) values (30,1,'info','permissions','update from code','null','2015-07-21 21:02:40','[]');
insert  into `maverick_cms_logs`(`id`,`user_id`,`type`,`category`,`sub_category`,`details`,`added_at`,`request_data`) values (31,1,'info','tags','updated','{\"uk\":[\"England\",\"Ireland\",\"Scotland\",\"Wales\"],\"page types\":[\"portfolio\",\"page\",\"blog\"],\"fruits\":[\"apple\",\"banana\",\"pear\",\"orange\"]}','2015-07-30 11:55:19','{\"tag_count\":[\"4\",\"3\",\"4\",\"0\"],\"tag_group\":[\"uk\",\"page types\",\"fruits\",\"ungrouped\"],\"tag\":[]}');
...
insert  into `maverick_cms_permissions`(`id`,`name`,`description`) values (47,'logs','');
insert  into `maverick_cms_permissions`(`id`,`name`,`description`) values (48,'tags','');
...
insert  into `maverick_cms_tag_groups`(`id`,`group_name`) values (1,'fruits');
insert  into `maverick_cms_tag_groups`(`id`,`group_name`) values (46,'page types');
insert  into `maverick_cms_tag_groups`(`id`,`group_name`) values (2,'uk');
...
insert  into `maverick_cms_tags`(`id`,`tag`,`group_id`) values (1,'apple',1);
insert  into `maverick_cms_tags`(`id`,`tag`,`group_id`) values (2,'banana',1);
insert  into `maverick_cms_tags`(`id`,`tag`,`group_id`) values (3,'pear',1);
insert  into `maverick_cms_tags`(`id`,`tag`,`group_id`) values (4,'orange',1);
insert  into `maverick_cms_tags`(`id`,`tag`,`group_id`) values (5,'England',2);
insert  into `maverick_cms_tags`(`id`,`tag`,`group_id`) values (6,'Ireland',2);
insert  into `maverick_cms_tags`(`id`,`tag`,`group_id`) values (7,'Scotland',2);
insert  into `maverick_cms_tags`(`id`,`tag`,`group_id`) values (8,'Wales',2);
insert  into `maverick_cms_tags`(`id`,`tag`,`group_id`) values (9,'page',46);
insert  into `maverick_cms_tags`(`id`,`tag`,`group_id`) values (10,'blog',46);
insert  into `maverick_cms_tags`(`id`,`tag`,`group_id`) values (11,'portfolio',46);
